...
//        CompleteInput.selectById(wait, "login", "asociacionsas3@yopmail.com");
//        ClicButton.clicByTitle(driver, wait, "Revisa el correo @yopmail.com");
//        ReadEmails.readEmail(driver,wait,"Invitación a Portal de Proveedores", "correoContenido", "Ingresar a la plataforma", settings.baseUrl + "sign-in");
        Login.LoginNewProvider(driver, wait, "pruebadev1@yopmail.com", "O3CBr1819&189.77605265528308", "Pass1234*", settings.baseUrl);
//        UrlChange.validateUrl(driver,wait, settings.baseUrl + "sign-in", settings.baseUrl + "enterprise/forms/registration");
...
//
//        RetryUtils.retryUntilSuccess(() -> {
//            SelectFunctions.selectListOptionById(wait, "mat-select-1", "ABEJORRAL-ANTIOQUIA");
//            return null;
//        }, 3, 5000);
//
...
//        CompleteInput.selectById(wait, "mat-input-11", "correoreplegal@yopmail.com");
...
//
//        RetryUtils.retryUntilSuccess(() -> {
//            SelectFunctions.selectListOptionByXPath(driver, wait,"Tipo", "CEDULA DE CIUDADANIA");
//            return null;
//        }, 3, 9000);
//
//        RetryUtils.retryUntilSuccess(() -> {
